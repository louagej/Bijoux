...
public class UserTeamAsyncDelete extends AsyncTask<String[], Integer, User> {
	...
	public UserTeamAsyncDelete(Context context,
	...
	protected User doInBackground(String[]... params) {
		//String tag = "UserTeamAsyncDelete doInBackground";
		// Building Parameters
		// Please make sure the spellings of the keys are correct
		List<NameValuePair> params1 = new ArrayList<NameValuePair>();
		params1.add(new BasicNameValuePair("method", "deleteUserTeam"));
		...
		params1.add(new BasicNameValuePair("user_id_to_remove", parameters[1]));
		params1.add(new BasicNameValuePair("teams_to_remove_member", parameters[2]));
